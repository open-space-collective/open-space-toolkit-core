...
class TestObject:
    def test_operators(self):
        ...
        assert Object.array(
            [Object.integer(123), Object.real(123.456), Object.string("abc")]
        )[0] == Object.integer(123)
        assert Object.array(
            [Object.integer(123), Object.real(123.456), Object.string("abc")]
        )[1] == Object.real(123.456)
        assert Object.array(
            [Object.integer(123), Object.real(123.456), Object.string("abc")]
        )[2] == Object.string("abc")
    ...
    def test_get_dictionary(self):
        assert (
            Object.dictionary(Dictionary.empty()).get_dictionary() == Dictionary.empty()
        )

    def test_get_array(self):
        assert Object.array(
            [Object.integer(123), Object.real(123.456), Object.string("abc")]
        ).get_array() == [Object.integer(123), Object.real(123.456), Object.string("abc")]
    ...
    def test_load(self):
        ...
        with NamedTemporaryFile() as file:
            ...
            assert (
                Object.load(
                    file=File.path(Path.parse(file.name)), format=Object.Format.YAML
                )
                == reference_object
            )

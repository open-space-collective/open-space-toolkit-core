...
# @file           tools/testing/python/3.7/run.sh
...
run_container ()
{
    ...
    --volume="${project_directory}/lib/liblibrary-core.so:/usr/local/lib/python3.7/site-packages/Library/Core/liblibrary-core.so:ro" \
    --volume="${project_directory}/lib/liblibrary-core.so.0:/usr/local/lib/python3.7/site-packages/Library/Core/liblibrary-core.so.0:ro" \
    --volume="${project_directory}/lib/LibraryCorePy.so:/usr/local/lib/python3.7/site-packages/Library/Core/LibraryCorePy.so:ro" \

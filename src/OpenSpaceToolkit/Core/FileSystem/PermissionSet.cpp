...
{
    return (read_ == aPermissionSet.read_) && (write_ == aPermissionSet.write_) &&
           (execute_ == aPermissionSet.execute_);
}
...
std::ostream& operator<<(std::ostream& anOutputStream, const PermissionSet& aPermissionSet)
{
